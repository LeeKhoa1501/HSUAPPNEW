...
// --- API BASE URL ---
const API_BASE_URL = 'http://10.101.38.182:5000'; // <-- Sửa lại IP/URL backend đúng
        ...
        <SafeAreaView style={styles.safeArea}>
            ...
            {!error && (!isLoading || allExamEntries.length >= 0) && ( // Điều kiện đảm bảo luôn render ScrollView sau khi hết loading ban đầu
                 ...
                 >
                     {/* --- Component Lịch --- */}
                     <Calendar
                         // key={currentMonthDate.toISOString()} // Có thể dùng key nếu cần force re-render mạnh hơn
